 ...
 *
 */
package net.farpoproject.bilikova;
...
@Mod("bilikova")
public class BilikovaMod {
	public static final Logger LOGGER = LogManager.getLogger(BilikovaMod.class);
	public static final String MODID = "bilikova";
